            ...
            if tokens[3].value == 'ds':
                ...
                if tokens[5].value == '+':
                    if tokens[6].value in REGISTERS or tokens[6].value == 'eiz':
                        ...
                        if disp <= 0x7f:
                            modrm = 0b01000000 | src << 3 | reg
                            return prefix + b'\x00' + pack('<B', modrm) + sib + pack('<B', disp)
                        else:
                            modrm = 0b10000000 | src << 3 | reg
                            return prefix + b'\x00' + pack('<B', modrm) + sib + pack('<I', disp)
                elif tokens[5].value == '-':
                    disp = -int(tokens[6].value, base=16)
                    assert tokens[7].value == ']'
                    assert tokens[8].value == ','
                ...
                if tokens[5].value == '+':
                    if tokens[6].value in REGISTERS or tokens[6].value == 'eiz':
                        ...
                        if tokens[9].value in REGISTERS:
                            ...
                            if disp <= 0x7f:
                                modrm = 0b01000000 | src << 3 | reg
                                return b'\x01' + pack('<B', modrm) + sib + pack('<B', disp)
                            else:
                                modrm = 0b10000000 | src << 3 | reg
                                return b'\x01' + pack('<B', modrm) + sib + pack('<I', disp)
                        else:
                            im = int(tokens[9].value, base=16)
                            sib = get_sib(reg)
                            if disp <= 0x7f:
                                ...
                                if im <= 0x7f or im >= 0xffffff00:
                                    return b'\x83' + pack('<B', modrm) + sib + pack('<B', disp) + pack('<B', im & 0xff)
                                else:
                                    return b'\x81' + pack('<B', modrm) + sib + pack('<B', disp) + pack('<I', im)
                            else:
                                modrm = 0b10000000 | reg
                                if im <= 0x7f or im >= 0xffffff00:
                                    return b'\x83' + pack('<B', modrm) + sib + pack('<I', disp) + pack('<B', im & 0xff)
                                else:
                                    return b'\x83' + pack('<B', modrm) + sib + pack('<I', disp) + pack('<I', im)
                elif tokens[5].value == '-':
                    disp = int(tokens[6].value, base=16)
                    assert tokens[7].value == ']'
                    assert tokens[8].value == ','
                ...
                if tokens[5].value == 'ds':
                    ...
                    if tokens[7].value == ']':
                        ...
                        if tokens[8].value in REGISTERS:
                            ...
                            if disp <= 0x7f:
                                modrm = 0b01000000 | dst << 3 | base
                                return b'\x66\x3b' + pack('<B', modrm) + sib + pack('<B', disp)
                            else:
                                modrm = 0b10000000 | dst << 3 | base
                                return b'\x66\x3b' + pack('<B', modrm) + sib + pack('<I', disp)
                    elif tokens[7].value == '-':
                        disp = int(tokens[8].value, base=16)
                        assert tokens[9].value == ']'
                        modrm = 0b01000000 | dst << 3 | base
                ...
                if tokens[5].value == ']':
                    ...
                    if tokens[6].value in REGISTERS:
                        ...
                        if disp <= 0x7f:
                            ...
                            return b'\xfe' + pack('<B', modrm) + sib + pack('<B', disp)
                        else:
                            modrm = 0b10001000 | base
                            return b'\xfe' + pack('<B', modrm) + sib + pack('<I', disp)
                elif tokens[5].value == '-':
                    disp = int(tokens[6].value, base=16)
                    modrm = 0b01001000 | base
            ...
            if tokens[3].value == '[':
                ...
                if tokens[5].value == ']':
                    ...
                    if tokens[6].value in REGISTERS:
                        ...
                        if disp <= 0x7f:
                            modrm = 0b01001000 | base
                            return b'\x66\xff' + pack('<B', modrm) + sib +  pack('<B', disp)
                        else:
                            modrm = 0b10001000 | base
                            return b'\x66\xff' + pack('<B', modrm) + sib + pack('<I', disp)
                elif tokens[5].value == '-':
                    disp = int(tokens[6].value, base=16)
                    assert tokens[7].value == ']'
                    sib = get_sib(base)
            ...
            if tokens[3].value == 'ds':
                ...
                if tokens[5].value == ']':
                    ...
                    if tokens[6].value in REGISTERS:
                        ...
                        if disp <= 0x7f:
                            modrm = 0b01001000 | base
                            return b'\xff' + pack('<B', modrm) + sib +  pack('<B', disp)
                        else:
                            modrm = 0b10001000 | base
                            return b'\xff' + pack('<B', modrm) + sib + pack('<I', disp)
                elif tokens[5].value == '-':
                    disp = int(tokens[6].value, base=16)
                    assert tokens[7].value == ']'
                    if disp <= 0x80:
                    ...
                    if tokens[7].value == ']':
                        ...
                        if tokens[8].value in REGISTERS:
                            ...
                            if len(tokens) == 10:
                                ...
                                if disp <= 0x7f:
                                    modrm = 0b01000000 | dst << 3 | base
                                    return b'\x0f\xaf' + pack('<B', modrm) + sib + pack('<B', disp)
                                else:
                                    modrm = 0b10000000 | dst << 3 | base
                                    return b'\x0f\xaf' + pack('<B', modrm) + sib + pack('<I', disp)
                            else:
                                im = int(tokens[11].value, base=16)
                                modrm = 0b01000000 | dst << 3 | base
                                if im <= 0x7f or im > 0xffffff00:
                ...
                if tokens[5].value == ']':
                    ...
                    if tokens[6].value == 'eiz':
                        ...
                        if tokens[9].value in REGISTERS8:
                            ...
                            if disp <= 0x7f:
                                modrm = 0b01000000 | src << 3 | base
                                return b'\x08' + pack('<B', modrm) + sib + pack('<B', disp)
                            else:
                                modrm = 0b10000000 | src << 3 | base
                                return b'\x08' + pack('<B', modrm) + sib + pack('<I', disp)
                        else:
                            im = int(tokens[9].value, base=16)
                            if disp <= 0x7f:
                                modrm = 0b01001000 | base
                                return b'\x80' + pack('<B', modrm) + sib + pack('<B', disp) + pack('<B', im)
                            else:
                                modrm = 0b10001000 | base
                                return b'\x80' + pack('<B', modrm) + sib + pack('<I', disp) + pack('<B', im)
                elif tokens[5].value == '-':
                    disp = int(tokens[6].value, base=16)
                    assert tokens[7].value == ']'
                    assert tokens[8].value == ','
            ...
            if tokens[3].value == 'ds':
                ...
                if tokens[5].value == ']':
                    ...
                    if tokens[6].value in REGISTERS:
                        ...
                        modrm = 0b01000000 | src << 3 | base
                        if disp <= 0x7f:
                            return prefix + b'\x09' + pack('<B', modrm) + sib + pack('<B', disp)
                        else:
                            modrm = 0b10000000 | src << 3 | base
                            return prefix + b'\x09' + pack('<B', modrm) + sib + pack('<I', disp)
                elif tokens[5].value == '-':
                    disp = int(tokens[6].value, base=16)
                    assert tokens[7].value == ']'
                    assert tokens[8].value == ','
            ...
            if tokens[3].value in REGISTERS8:
                ...
                if tokens[7].value == ']':
                    ...
                    if tokens[8].value in REGISTERS:
                        ...
                        if disp <= 0x7f:
                            modrm = 0b01000000 | dst << 3 | base
                            return b'\x0a' + pack('<B', modrm) + sib + pack('<B', disp)
                        else:
                            modrm = 0b10000000 | dst << 3 | base
                            return b'\x0a' + pack('<B', modrm) + sib + pack('<I', disp)
                elif tokens[7].value == '-':
                    disp = int(tokens[8].value, base=16)
                    assert tokens[9].value == ']'
                    if disp <= 0x7f:
            ...
            if tokens[3].value in REGISTERS:
                ...
                if tokens[7].value == ']':
                    ...
                    if tokens[8].value in REGISTERS:
                        ...
                        sib = get_sib(base)
                        if disp <= 0x7f:
                            return b'\x0b' + pack('<B', modrm) + sib + pack('<B', disp)
                        else:
                            modrm = 0b10000000 | dst << 3 | base
                            return b'\x0b' + pack('<B', modrm) + sib + pack('<I', disp)
                elif tokens[7].value == '-':
                    disp = int(tokens[8].value, base=16)
                    assert tokens[9].value == ']'
                    if disp <= 0x7f:
                ...
                if tokens[5].value == 'ds':
                    ...
                    if tokens[7].value == ']':
                        ...
                        if tokens[8].value in REGISTERS:
                            ...
                            if disp <= 0x7f:
                                modrm = 0b01000000 | dst << 3 | base
                                return b'\x2b' + pack('<B', modrm) + sib + pack('<B', disp)
                            else:
                                modrm = 0b10000000 | dst << 3 | base
                                return b'\x2b' + pack('<B', modrm) + sib + pack('<I', disp)
                    elif tokens[7].value == '-':
                        disp = int(tokens[8].value, base=16)
                        assert tokens[9].value == ']'
                        if disp <= 0x80:
