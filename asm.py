                    ...
                    if tokens[6].value in REGISTERS:
                        ...
                        if reg == REGISTERS.index('esp'):
                            ...
                            if disp <= 0x7f:
                                ...
                                return prefix + op + pack('<B', modrm) + pack('<B', sib) + pack('<B', disp)
                            else:
                            ...
                            if disp <= 0x7f:
                                modrm = 0b01000000 | mod << 3 | reg
                                return prefix + op + pack('<B', modrm) + pack('<B', disp)
                            else:
                                modrm = 0b10000000 | mod << 3 | reg
    ...
    if opcode == 'AAA':
        ...
        if tokens[1].value == 'BYTE':
            ...
            if tokens[5].value == ']':
                ...
                if tokens[6].value in REGISTERS:
                    ...
                    return b'\x82\x54\x81' + pack('<B', disp) + pack('<B', ib)
                else:
                    disp = int(tokens[6].value, base=16)
                    assert tokens[7].value == ']'
                    ...
                    if tokens[9].value in REGISTERS8:
                        ...
                        if disp <= 0x7f:
                            ...
                            return b'\x10' + pack('<B', modrm) + pack('<B', disp)
                        else:
                            modrm = 0b10000000 | src << 3 | reg
                            return b'\x10' + pack('<B', modrm) + pack('<I', disp)
                    else:
                ...
                if tokens[6].value in REGISTERS:
                    ...
                    if tokens[9].value == ']':
                        ...
                        if disp <= 0x7f:
                            ...
                            return b'\x11' + pack('<B', modrm) + pack('<B', sib) + pack('<B', disp)
                        else:
                            modrm = 0b10000100 | src << 3
                            return b'\x11' + pack('<B', modrm) + pack('<B', sib) + pack('<I', disp)
                    elif tokens[9].value == '-':
                        disp = int(tokens[10].value, base=16)
                        assert tokens[11].value == ']'
                        assert tokens[12].value == ','
                    ...
                    if tokens[9].value in REGISTERS:
                        ...
                        if disp <= 0x7f:
                            modrm = 0b01000000 | src << 3 | reg
                            return b'\x11' + pack('<B', modrm) + pack('<B', disp)
                        else:
                            modrm = 0b10000000 | src << 3 | reg
                            return b'\x11' + pack('<B', modrm) + pack('<I', disp)
                    else:
                        ib = int(tokens[9].value, base=16)
            ...
            if tokens[3].value == 'BYTE':
                ...
                if tokens[7].value == ']':
                    ...
                    if tokens[8].value in REGISTERS:
                        ...
                        return prefix + b'\x12' + pack('<B', modrm) + pack('<B', disp)
                elif tokens[7].value == '-':
                    disp = int(tokens[8].value, base=16)
                    assert tokens[9].value == ']'
                    modrm = 0b10000000 | dst << 3 | reg
                    return b'\x12' + pack('<B', modrm) + pack('<i', -disp)
                    ...
                    if tokens[7].value == ']':
                        ...
                        if tokens[8].value in REGISTERS:
                            ...
                            if tokens[11].value == ']':
                                ...
                                disp = int(tokens[12].value, base=16)
                                return b'\x13\x64\x00' + pack('<B', disp)
                            elif tokens[11].value == '-':
                                disp = int(tokens[12].value, base=16)
                                return b'\x13\x64\x00' + pack('<b', -disp)
                        else:
        ...
        if tokens[1].value == 'BYTE':
            ...
            if tokens[3].value == 'ds':
                ...
                if tokens[4].value in REGISTERS16:
                    reg = REGISTERS16.index(tokens[4].value)
                    if tokens[5].value == '+':
                        if tokens[6].value in REGISTERS16:
                            ...
                            if tokens[7].value == ']':
                                ...
                                src = REGISTERS8.index(tokens[11].value)
                                if disp <= 0x7f:
                                    modrm = 0b01000001 | src << 3
                                    return b'\x67\x00' + pack('<B', modrm) + pack('<B', disp)
                                else:
                                    modrm = 0b10000001 | src << 3 | (reg - 2)
                ...
                if tokens[5].value == '+':
                    if tokens[6].value in REGISTERS or tokens[6].value == 'eiz':
                        ...
                        if tokens[9].value == '+':
                            ...
                            sib = 0b00000000 | scale << 6 | idx << 3 | reg
                            if disp <= 0xff:
                                return prefix + b'\x00' + pack('<B', modrm) + pack('<B', sib) + pack('<B', disp)
                            else:
                                modrm = 0b10000100 | src << 3
                                return prefix + b'\x00' + pack('<B', modrm) + pack('<B', sib) + pack('<I', disp)
                        elif tokens[9].value == '-':
                        ...
                        if disp <= 0x7f:
                            modrm = 0b01000000 | src << 3 | reg
                            return prefix + b'\x00' + pack('<B', modrm) + mod + pack('<B', disp)
                        else:
                            modrm = 0b10000000 | src << 3 | reg
                            return prefix + b'\x00' + pack('<B', modrm) + mod + pack('<I', disp)
                elif tokens[5].value == '-':
                    disp = -int(tokens[6].value, base=16)
                    assert tokens[7].value == ']'
                    assert tokens[8].value == ','
                    ...
                    if abs(disp) <= 0x7f:
                        modrm = 0b01000000 | src << 3 | reg
                        return prefix + b'\x00' + pack('<B', modrm) + pack('<b', disp)
                    else:
                        modrm = 0b10000000 | src << 3 | reg
                        return prefix + b'\x00' + pack('<B', modrm) + pack('<i', disp)
                elif tokens[5].value == '*':
                    scale = get_scale(tokens[6].value)
                    if tokens[7].value == '+':
                        disp = int(tokens[8].value, base=16)
                ...
                if tokens[5].value == ']':
                    ...
                    if tokens[6].value in REGISTERS:
                        ...
                        if disp <= 0x7f:
                            ...
                            modrm = 0b10000000 | src << 3 | reg
                            return b'\x66\x01' + pack('<B', modrm) + pack('<I', disp)
                elif tokens[5].value == '-':
                    disp = int(tokens[6].value, base=16)
                    assert tokens[7].value == ']'
                    assert tokens[8].value == ','
                    ...
                    if tokens[6].value in REGISTERS or tokens[6].value == 'eiz':
                        ...
                        if tokens[9].value in REGISTERS:
                            ...
                            if disp <= 0x7f:
                                ...
                                modrm = 0b10000000 | src << 3 | reg
                                return b'\x01' + pack('<B', modrm) + mod + pack('<I', disp)
                        else:
                            im = int(tokens[9].value, base=16)
                            mod = b''
                            if reg == REGISTERS.index('esp'):
                            ...
                            if disp <= 0x7f:
                                ...
                                if im <= 0x7f or im >= 0xffffff00:
                                    return b'\x83' + pack('<B', modrm) + mod + pack('<B', disp) + pack('<B', im & 0xff)
                                else:
                                    return b'\x81' + pack('<B', modrm) + mod + pack('<B', disp) + pack('<I', im)
                            else:
                                modrm = 0b10000000 | reg
                                if im <= 0x7f or im >= 0xffffff00:
                                    return b'\x83' + pack('<B', modrm) + mod + pack('<I', disp) + pack('<B', im & 0xff)
                                else:
                                    return b'\x83' + pack('<B', modrm) + mod + pack('<I', disp) + pack('<I', im)
                elif tokens[5].value == '-':
                    disp = int(tokens[6].value, base=16)
                    assert tokens[7].value == ']'
                    assert tokens[8].value == ','
                ...
                if tokens[5].value == 'ds':
                    ...
                    if tokens[7].value == ']':
                        ...
                        if tokens[8].value in REGISTERS:
                            ...
                            if disp <= 0x7f:
                                modrm = 0b01000000 | dst << 3 | reg
                                return prefix + b'\x02' + pack('<B', modrm) + pack('<B', disp)
                            else:
                                modrm = 0b10000000 | dst << 3 | reg
                                return prefix + b'\x02' + pack('<B', modrm) + pack('<I', disp)
            else:
                ib = int(tokens[3].value, base=16)
                ...
                if tokens[5].value == 'ds':
                    ...
                    if tokens[7].value == ']':
                        ...
                        if tokens[8].value in REGISTERS:
                            ...
                            if im <= 0x7f:
                                modrm = 0b01000000 | dst << 3 | reg
                                return b'\x03' + pack('<B', modrm) + mod + pack('<B', im)
                            else:
                                modrm = 0b10000000 | dst << 3 | reg
                                return b'\x03' + pack('<B', modrm) + mod + pack('<I', im)
                    elif tokens[7].value == '-':
                        im = int(tokens[8].value, base=16)
                        assert tokens[9].value == ']'
                        if im <= 0x80:
            ...
            if tokens[5].value == ']':
                ...
                if tokens[6].value in REGISTERS:
                    ...
                    if tokens[9].value in REGISTERS8:
                        ...
                        im = int(tokens[9].value, base=16)
                        if disp <= 0x7f:
                            modrm = 0b01100000 | reg
                            return b'\x80' + pack('<B', modrm) + pack('<B', disp) + pack('<B', im & 0xff)
                        else:
                            modrm = 0b10100000 | reg
                            return b'\x80' + pack('<B', modrm) + pack('<I', disp) + pack('<B', im & 0xff)
            elif tokens[5].value == '-':
                disp = int(tokens[6].value, base=16)
                assert tokens[7].value == ']'
                assert tokens[8].value == ','
                ...
                if tokens[5].value == ']':
                    ...
                    if tokens[6].value in REGISTERS:
                        ...
                        if tokens[9].value == ']':
                            ...
                            if tokens[13].value in REGISTERS:
                                ...
                                if disp <= 0x7f:
                                    ...
                                    modrm = 0b10000100 | src << 3
                                    return b'\x21' + pack('<B', modrm) + pack('<B', sib) + pack('<I', disp)
                            else:
                                im = int(tokens[13].value, base=16)
                                sib = 0b00000000 | scale << 6 | idx << 3 | reg
                                if disp <= 0x7f:
                                    ...
                                    modrm = 0b10100100
                                    return b'\x83' + pack('<B', modrm) + pack('<B', sib) + pack('<I', disp) + pack('<B', im)
                        elif tokens[9].value == '-':
                            disp = int(tokens[10].value, base=16)
                            assert tokens[11].value == ']'
                            assert tokens[12].value == ','
                        ...
                        if tokens[9].value in REGISTERS:
                            src = REGISTERS.index(tokens[9].value)
                            modrm = 0b01000000 | src << 3 | reg
                            return b'\x21' + pack('<B', modrm) + mod + pack('<B', disp)
                        else:
                            im = int(tokens[9].value, base=16)
                            if disp <= 0x7f:
                                modrm = 0b01100000 | reg
                ...
                if tokens[5].value == 'ds':
                    ...
                    if tokens[7].value == ']':
                        ...
                        if tokens[8].value in REGISTERS or tokens[8].value == 'eiz':
                            ...
                            if reg == REGISTERS.index('esp'):
                                mod = b'\x24'
                            return b'\x23' + pack('<B', modrm) + mod + pack('<B', disp)
                    elif tokens[7].value == '-':
                        disp = int(tokens[8].value, base=16)
                        assert tokens[9].value == ']'
                        modrm = 0b01000000 | dst << 3 | reg
                    ...
                    if tokens[6].value in REGISTERS:
                        ...
                        if tokens[9].value in REGISTERS:
                            ...
                            if base == REGISTERS.index('esp'):
                                ...
                                if disp <= 0x7f:
                                    modrm = 0b01000000 | src << 3 | base
                                    return b'\x38' + pack('<B', modrm) + pack('<B', disp)
                                else:
                                    modrm = 0b10000000 | src << 3 | base
                                    return b'\x38' + pack('<B', modrm) + pack('<I', disp)
                        else:
                            ib = int(tokens[9].value, base=16)
                            if base == REGISTERS.index('esp'):
                                if disp <= 0x7f:
                                    modrm = 0b01111000 | base
                                    return b'\x80' + pack('<B', modrm) + b'\x24' + pack('<B', disp) + pack('<B', ib)
                                else:
                                    modrm = 0b10111000 | base
                                    return b'\x80' + pack('<B', modrm) + b'\x24' + pack('<I', disp) + pack('<B', ib)
                            else:
                                if disp <= 0x7f:
                                    modrm = 0b01111000 | base
                                    ...
                                    modrm = 0b10111000 | base
                                    return b'\x80' + pack('<B', modrm) + pack('<I', disp) + pack('<B', ib)
                elif tokens[5].value == '-':
                    disp = int(tokens[6].value, base=16)
                    assert tokens[7].value == ']'
                    assert tokens[8].value == ','
                ...
                if tokens[5].value == ']':
                    ...
                    if tokens[7].value in REGISTERS16:
                        ...
                        if im <= 0x7f:
                            ...
                            return b'\x66\x83' + pack('<B', modrm) + mod + pack('<B', im)
                        else:
                            modrm = 0b00111000 | base
                            return b'\x66\x81' + pack('<B', modrm) + mod + pack('<H', im)
                elif tokens[5].value == '+':
                    if tokens[6].value in REGISTERS:
                        idx = REGISTERS.index(tokens[6].value)
                        assert tokens[7].value == '*'
                        ...
                        if tokens[9].value in REGISTERS16:
                            ...
                            if base == REGISTERS.index('esp'):
                                if disp <= 0x7f:
                                    modrm = 0b01000000 | src << 3 | base
                                    return b'\x66\x39' + pack('<B', modrm) + b'\x24' + pack('<B', disp)
                                else:
                                    modrm = 0b10000000 | src << 3 | base
                                    return b'\x66\x39' + pack('<B', modrm) + b'\x24' + pack('<I', disp)
                            else:
                                if disp <= 0x7f:
                                    modrm = 0b01000000 | src << 3 | base
                                    ...
                                    modrm = 0b10000000 | src << 3 | base
                                    return b'\x66\x39' + pack('<B', modrm) + pack('<I', disp)
                        else:
                            ib = int(tokens[9].value, base=16)
                            if base == REGISTERS.index('esp'):
                                if disp <= 0x7f:
                                    if ib <= 0x7f:
                                        return b'\x66\x83\x7c\x24' + pack('<B', disp) + pack('<B', ib)
                                    else:
                                        return b'\x66\x81\x7c\x24' + pack('<B', disp) + pack('<H', ib)
                                else:
                                    return b'\x66\x83\xbc\x24' + pack('<I', disp) + pack('<B', ib)
                            else:
                                if disp <= 0x7f:
                                    if ib <= 0x7f:
                                        modrm = 0b01111000 | base
                                        return b'\x66\x83' + pack('<B', modrm) + pack('<B', disp) + pack('<B', ib)
                                    else:
                                        modrm = 0b01111000 | base
                                        return b'\x66\x81' + pack('<B', modrm) + pack('<B', disp) + pack('<H', ib)
                                else:
                                    if ib <= 0x7f:
                                        modrm = 0b10111000 | base
                                        return b'\x66\x83' + pack('<B', modrm) + pack('<I', disp) + pack('<B', ib)
                                    else:
                                        assert False
                elif tokens[5].value == '-':
                    disp = int(tokens[6].value, base=16)
                ...
                if tokens[5].value == ']':
                    ...
                    if tokens[7].value in REGISTERS:
                        ...
                        if imm <= 0x7f or imm >= 0xffffff00:
                            return b'\x83' + pack('<B', 0b00111000 | reg) + pack('<B', imm & 0xff)
                        else:
                            return b'\x81' + pack('<B', 0b00111000 | reg) + pack('<I', imm)
                elif tokens[5].value == '+':
                    if tokens[6].value in REGISTERS:
                        idx = REGISTERS.index(tokens[6].value)
                        if tokens[7].value == '*':
                            ...
                            if tokens[9].value == ']':
                                ...
                                if tokens[13].value in REGISTERS:
                                    ...
                                    if disp <= 0x7f:
                                        sib = 0b00000000 | scale << 6 | idx << 3 | reg
                                        modrm = 0b01111100
                                        return b'\x83' + pack('<B', modrm) + pack('<B', sib) + pack('<b', -disp) + pack('<B', im & 0xff)
                                    else:
                                        modrm = 0b10111100
                                        sib = 0b00000000 | scale << 6 | idx << 3 | reg
                                        return b'\x81' + pack('<B', modrm) + pack('<B', sib) + pack('<i', -disp) + pack('<I', im)
                        else:
                            assert False, 'Not implemented yet'
                    else:
                        disp = int(tokens[6].value, base=16)
                        ...
                        if tokens[9].value in REGISTERS:
                            ...
                            if reg == REGISTERS.index('esp'):
                                ...
                                if disp <= 0x7f:
                                    if ib <= 0x7f or ib >= 0xffffff00:
                                        return b'\x83' + pack('<B', modrm) + pack('<B', sib) + pack('<B', disp) + pack('<B', ib & 0xff)
                                    else:
                                        return b'\x81' + pack('<B', modrm) + pack('<B', sib) + pack('<B', disp) + pack('<I', ib)
                                else:
                                    modrm = 0b10111000 | reg
                                    return b'\x83' + pack('<B', modrm) + pack('<B', sib) + pack('<I', disp) + pack('<B', ib & 0xff)
                            else:
                                if disp <= 0x7f:
                                    if ib <= 0x7f or ib >= 0xffffff00:
                                        return b'\x83' + pack('<B', modrm) + pack('<B', disp) + pack('<B', ib & 0xff)
                                    else:
                                        return b'\x81' + pack('<B', modrm) + pack('<B', disp) + pack('<I', ib)
                                else:
                                    if ib <= 0x7f or ib >= 0xffffff00:
                                        modrm = 0b10111000 | reg
                                        return b'\x83' + pack('<B', modrm) + pack('<I', disp) + pack('<B', ib & 0xff)
                                    else:
                                        modrm = 0b10111000 | reg
                                        return b'\x81' + pack('<B', modrm) + pack('<I', disp) + pack('<I', ib)
                elif tokens[5].value == '-':
                    disp = int(tokens[6].value, base=16)
                    assert tokens[7].value == ']'
                    assert tokens[8].value == ','
                        ...
                        if tokens[8].value in REGISTERS:
                            ...
                            if base == REGISTERS.index('esp'):
                                ...
                                if disp <= 0x7f:
                                    ...
                                    modrm = 0b10000000 | dst << 3 | base
                                    return b'\x3b' + pack('<B', modrm) + b'\x24' + pack('<I', disp)
                            else:
                                if disp <= 0x7f:
                                    modrm = 0b01000000 | dst << 3 | base
                    ...
                    if tokens[7].value == ']':
                        ...
                        if tokens[8].value in REGISTERS:
                            ...
                            if tokens[11].value == '+':
                                ...
                                if disp <= 0x7f:
                                    modrm = 0b01000100 | dst << 3
                                    return b'\x3a' + pack('<B', modrm) + pack('<B', sib) + pack('<B', disp)
                                else:
                                    modrm = 0b10000100 | dst << 3
                                    return b'\x3a' + pack('<B', modrm) + pack('<B', sib) + pack('<I', disp)
                            elif tokens[11].value == '-':
                                disp = int(tokens[12].value, base=16)
                                assert tokens[13].value == ']'
                            ...
                            if base == REGISTERS.index('esp'):
                                if disp <= 0x7f:
                                    modrm = 0b01000000 | dst << 3 | base
                                    return b'\x3a' + pack('<B', modrm) + b'\x24' + pack('<B', disp)
                                else:
                                    modrm = 0b10000000 | dst << 3 | base
                                    return b'\x3a' + pack('<B', modrm) + b'\x24' + pack('<I', disp)
                            else:
                                if disp <= 0x7f:
                                    modrm = 0b01000000 | dst << 3 | base
                                    ...
                                    modrm = 0b10000000 | dst << 3 | base
                                    return b'\x3a' + pack('<B', modrm) + pack('<I', disp)
                    elif tokens[7].value == '-':
                        disp = int(tokens[8].value, base=16)
                        assert tokens[9].value == ']'
                        modrm = 0b01000000 | dst << 3 | base
                ...
                if tokens[5].value == 'ds':
                    ...
                    if tokens[7].value == ']':
                        ...
                        if tokens[8].value in REGISTERS:
                            ...
                            if disp <= 0x7f:
                                modrm = 0b01000000 | dst << 3 | base
                                return b'\x66\x3b' + pack('<B', modrm) + mod + pack('<B', disp)
                            else:
                                modrm = 0b10000000 | dst << 3 | base
                                return b'\x66\x3b' + pack('<B', modrm) + mod + pack('<I', disp)
                    elif tokens[7].value == '-':
                        disp = int(tokens[8].value, base=16)
                        assert tokens[9].value == ']'
                        modrm = 0b01000000 | dst << 3 | base
                ...
                if tokens[5].value == ']':
                    ...
                    if tokens[6].value in REGISTERS:
                        ...
                        if disp <= 0x7f:
                            ...
                            return b'\xfe' + pack('<B', modrm) + mod + pack('<B', disp)
                        else:
                            modrm = 0b10001000 | base
                            return b'\xfe' + pack('<B', modrm) + mod + pack('<I', disp)
                elif tokens[5].value == '-':
                    disp = int(tokens[6].value, base=16)
                    modrm = 0b01001000 | base
            ...
            if tokens[3].value == '[':
                ...
                if tokens[5].value == ']':
                    ...
                    if tokens[6].value in REGISTERS:
                        ...
                        if disp <= 0x7f:
                            modrm = 0b01001000 | base
                            return b'\x66\xff' + pack('<B', modrm) + mod +  pack('<B', disp)
                        else:
                            modrm = 0b10001000 | base
                            return b'\x66\xff' + pack('<B', modrm) + mod + pack('<I', disp)
                elif tokens[5].value == '-':
                    disp = int(tokens[6].value, base=16)
                    assert tokens[7].value == ']'
                    mod = b''
            ...
            if tokens[3].value == 'ds':
                ...
                if tokens[5].value == ']':
                    ...
                    if tokens[6].value in REGISTERS:
                        ...
                        if disp <= 0x7f:
                            modrm = 0b01001000 | base
                            return b'\xff' + pack('<B', modrm) + mod +  pack('<B', disp)
                        else:
                            modrm = 0b10001000 | base
                            return b'\xff' + pack('<B', modrm) + mod + pack('<I', disp)
                elif tokens[5].value == '-':
                    disp = int(tokens[6].value, base=16)
                    assert tokens[7].value == ']'
                    if disp <= 0x80:
        ...
        if tokens[1].value in REGISTERS8:
            ...
            if tokens[3].value in REGISTERS16:
                ...
                if tokens[7].value == ']':
                    ...
                    if base == REGISTERS.index('esp'):
                        mod = b'\x24'
                    return b'\x66\x0f\xaf' + pack('<B', modrm) + mod + pack('<B', disp)
                else:
                    assert False
        elif tokens[1].value in REGISTERS:
            dst = REGISTERS.index(tokens[1].value)
            ...
            if tokens[5].value == '+':
                ...
                if base == REGISTERS.index('esp'):
                    ...
                    if disp <= 0x7f:
                        ...
                        modrm = 0b10101000 | base
                        return b'\xf6' + pack('<B', modrm) + pack('<I', disp)
            elif tokens[5].value == ']':
                modrm = 0b00100000 | base
                return b'\xf6' + pack('<B', modrm)
        elif tokens[1].value == 'DWORD':
                        ...
                        if tokens[9].value in REGISTERS8:
                            ...
                            if reg == REGISTERS.index('esp'):
                                if disp <= 0x7f:
                                    if reg == REGISTERS.index('esp'):
                                        modrm = 0b01000000 | src << 3 | reg
                                        return b'\x88' + pack('<B', modrm) + b'\x24' + pack('<B', disp)
                                    else:
                                        modrm = 0b01000000 | src << 3 | reg
                                        return b'\x88' + pack('<B', modrm) + b'\x24' + pack('<B', disp)
                                elif disp <= 0xff:
                                    modrm = 0b10000000 | src << 3 | reg
                                    return b'\x88' + pack('<B', modrm) + b'\x24' + pack('<I', disp)
                                else:
                                    return b'\x88' + pack('<B', modrm) + b'\x24' + pack('<I', disp)
                            else:
                                if disp <= 0x7f:
                                    ...
                                    if reg == REGISTERS.index('esp'):
                                        modrm = 0b01000000 | src << 3 | reg
                                        sib = 0b00100100
                                        return b'\x88' + pack('<B', modrm) + pack('<B', sib) + pack(fmt, sign*disp)
                                    else:
                                        modrm = 0b01000000 | src << 3 | reg
                                        return prefix + b'\x88' + pack('<B', modrm) + pack(fmt, sign*disp)
                                elif disp <= 0xff:
                                    fmt = '<I'
                                    if sign == -1:
                                        fmt = '<i'
                                    modrm = 0b10000000 | src << 3 | reg
                                    return b'\x88' + pack('<B', modrm) + pack(fmt, sign*disp)
                                else:
                                    fmt = '<I'
                                    if sign == -1:
                                        fmt = '<i'
                            ...
                            if reg == REGISTERS.index('esp'):
                                ...
                                if disp <= 0x7f:
                                    ...
                                    if sign == -1:
                                        fmt = '<b'
                                    modrm = 0b01000000 | reg
                                    return b'\xc6' + pack('<B', modrm) + pack(fmt, sign*disp) + pack('<B', ib)
                                else:
                                    fmt = '<I'
                                    if sign == -1:
                                        fmt = '<i'
            ...
            if tokens[3].value == '[':
                ...
                if tokens[5].value == ']':
                    ...
                    if tokens[7].value in REGISTERS:
                        src = REGISTERS.index(tokens[7].value)
                        modrm = 0b000000000 | src << 3 | reg
                        return b'\x89' + pack('<B', modrm) + mod
                    else:
                        im = int(tokens[7].value, base=16)
                        modrm = 0b000000000 | reg
                        return b'\xc7' + pack('<B', modrm) + mod + pack('<I', im)
                elif tokens[5].value == '-':
                    disp = int(tokens[6].value, base=16)
                    assert tokens[7].value == ']'
                    assert tokens[8].value == ','
            ...
            if tokens[3].value == 'ds':
                ...
                if tokens[5].value == ']':
                    ...
                    if tokens[6].value in REGISTERS:
                        ...
                        if tokens[9].value == ']':
                            ...
                            if tokens[13].value in REGISTERS16:
                                ...
                                if disp <= 0x7f:
                                    modrm = 0b01000100
                                    return prefix + b'\xc7' + pack('<B', modrm) + pack('<B', sib) + pack(fmt, sign*disp) + pack('<H', im)
                                else:
                                    modrm = 0b10000100
                                    return prefix + b'\xc7' + pack('<B', modrm) + pack('<B', sib) + pack('<I', disp) + pack('<H', im)
                    else:
                        disp = int(tokens[6].value, base=16)
                        assert tokens[7].value == ']'
                        assert tokens[8].value == ','
                        if tokens[9].value in REGISTERS16:
                            ...
                            if base == REGISTERS.index('esp'):
                                if disp <= 0x7f:
                                    modrm = 0b01000000 | src << 3 | base
                                    return prefix + b'\x89' + pack('<B', modrm) + b'\x24' + pack('<B', disp)
                                else:
                                    modrm = 0b10000000 | src << 3 | base
                                    return prefix + b'\x89' + pack('<B', modrm) + b'\x24' + pack('<I', disp)
                            else:
                                if disp <= 0x7f:
                                    modrm = 0b01000000 | src << 3 | base
                                    return prefix + b'\x89' + pack('<B', modrm) + pack('<B', disp)
                                else:
                                    modrm = 0b10000000 | src << 3 | base
                                    return prefix + b'\x89' + pack('<B', modrm) + pack('<I', disp)
                        if tokens[9].value == '?':
                            if prefix == b'\x66':
                                prefix = b''
                            modrm = 0b01111000 | base
                        ...
                        if tokens[9].value in SEGMENTS:
                            ...
                            if base == REGISTERS.index('esp'):
                                if disp <= 0x7f:
                                    modrm = 0b01000000 | base
                                    return prefix + b'\xc7' + pack('<B', modrm) + b'\x24' + pack('<B', disp) + pack('<H', im)
                                else:
                                    modrm = 0b10000000 | base
                                    return prefix + b'\xc7' + pack('<B', modrm) + b'\x24' + pack('<I', disp) + pack('<H', im)
                            else:
                                if disp <= 0x7f:
                                    modrm = 0b01000000 | base
                                    ...
                                    modrm = 0b10000000 | base
                                    return prefix + b'\xc7' + pack('<B', modrm) + pack('<I', disp) + pack('<H', im)
                elif tokens[5].value == '-':
                    sign = {'+': 1, '-': -1}[tokens[5].value]
                    ...
                    if tokens[9].value in REGISTERS16:
                        ...
                        if disp <= 0x7f:
                            modrm = 0b01000000 | src << 3 | base
                            return prefix + b'\x89' + pack('<B', modrm) + pack(fmt, sign*disp)
                        else:
                            fmt = '<I'
                            if sign == -1:
                                fmt = '<i'
                    ...
                    if tokens[7].value == ']':
                        ...
                        if tokens[8].value in REGISTERS:
                            ...
                            if tokens[11].value == ']':
                                ...
                                if disp <= 0x7f:
                                    modrm = 0b01000100 | dst << 3
                                    return b'\x8a' + pack('<B', modrm) + pack('<B', sib) + pack(fmt, sign*disp)
                                else:
                                    fmt = '<I'
                                    if sign == -1:
                                        fmt = '<i'
                            ...
                            if reg == REGISTERS.index('esp'):
                                if disp <= 0x7f:
                                    modrm = 0b01000000 | dst << 3 | reg
                                    return b'\x8a' + pack('<B', modrm) + b'\x24' + pack('<B', disp)
                                else:
                                    modrm = 0b10000000 | dst << 3 | reg
                                    return b'\x8a' + pack('<B', modrm) + b'\x24' + pack('<I', disp)
                            else:
                                if disp <= 0x7f:
                                    modrm = 0b01000000 | dst << 3 | reg
                ...
                if tokens[3].value == 'esp':
                    ...
                    if tokens[7].value == ']':
                        ...
                        if tokens[8].value in REGISTERS:
                            ...
                            disp = int(tokens[8].value, base=16)
                            assert tokens[9].value == ']'
                            modrm = 0b01000000 | seg << 3 | reg
                            return b'\x8e' + pack('<B', modrm) + pack('<B', disp)
                    elif tokens[7].value == '-':
                        disp = int(tokens[8].value, base=16)
                        assert tokens[9].value == ']'
                        modrm = 0b10000000 | seg << 3 | reg
        ...
        if tokens[1].value == 'DWORD':
            ...
            if tokens[5].value == ']':
                ...
                if base == REGISTERS.index('esp'):
                    modrm = 0b00000100 | src << 3
                    return b'\x0f\x7e' + pack('<B', modrm) + b'\x24'
                else:
                    modrm = 0b00000000 | src << 3 | base
                ...
                if base == REGISTERS.index('esp'):
                    modrm = 0b01000100 | src << 3
                    return b'\x0f\x7e' + pack('<B', modrm) + b'\x24' + pack('<B', disp)
                else:
                    modrm = 0b01000000 | src << 3 | base
                    return b'\x0f\x7e' + pack('<B', modrm) + pack('<B', disp)
            elif tokens[5].value == '-':
                disp = int(tokens[6].value, base=16)
                assert tokens[7].value == ']'
                assert tokens[8].value == ','
            ...
            if tokens[3].value in REGISTERS:
                ...
                if tokens[5].value == 'ds':
                    ...
                    if tokens[7].value == ']':
                        if base == REGISTERS.index('esp'):
                            modrm = 0b00000000 | dst << 3 | base
                            return b'\x0f\x6e' + pack('<B', modrm) + b'\x24'
                        else:
                            modrm = 0b00000000 | dst << 3 | base
                            return b'\x0f\x6e' + pack('<B', modrm)
                    elif tokens[7].value == '+':
                        ...
                        if base == REGISTERS.index('esp'):
                            if disp <= 0x7f:
                                modrm = 0b01000000 | dst << 3 | base
                                return b'\x0f\x6e' + pack('<B', modrm) + b'\x24' + pack('<B', disp)
                            else:
                                modrm = 0b10000000 | dst << 3 | base
                                return b'\x0f\x6e' + pack('<B', modrm) + b'\x24' + pack('<I', disp)
                        else:
                            modrm = 0b01000000 | dst << 3 | base
                            return b'\x0f\x6e' + pack('<B', modrm) + pack('<B', disp)
        else:
            assert False
    elif opcode == 'MOVDQA':
        dst = REGISTERSXMM.index(tokens[1].value)
                    ...
                    if tokens[8].value in REGISTERS:
                        ...
                        if tokens[11].value == ']':
                            ...
                            if disp <= 0x7f:
                                ...
                                modrm = 0b10000100 | dst << 3
                                return b'\x0f\xb6' + pack('<B', modrm) + pack('<B', sib) + pack('<I', disp)
                        elif tokens[11].value == '-':
                            disp = int(tokens[12].value, base=16)
                            modrm = 0b01000100 | dst << 3
                            sib = 0b00000000 | scale << 6 | idx << 3 | base
                        ...
                        if base == REGISTERS.index('esp'):
                            modrm = 0b01000000 | dst << 3 | base
                            return b'\x0f\xb6' + pack('<B', modrm) + b'\x24' + pack('<B', disp)
                        else:
                            if disp <= 0x7f:
                                modrm = 0b01000000 | dst << 3 | base
                                return b'\x0f\xb6' + pack('<B', modrm) + pack('<B', disp)
                            else:
                                modrm = 0b10000000 | dst << 3 | base
                                return b'\x0f\xb6' + pack('<B', modrm) + pack('<I', disp)
                elif tokens[7].value == '-':
                    if tokens[8].value in REGISTERS:
                        idx = REGISTERS.index(tokens[8].value)
                        assert tokens[9].value == '*'
                        ...
                        disp = int(tokens[8].value, base=16)
                        if base == REGISTERS.index('esp'):
                            return b'\x0f\xb6\x74\x24' + pack('<b', -disp)
                        else:
                            modrm = 0b01000000 | dst << 3 | base
                            return b'\x0f\xb6' + pack('<B', modrm) + pack('<b', -disp)
            elif tokens[3].value == 'WORD':
                ...
                if tokens[5].value == 'ds':
                    ...
                    if tokens[7].value == ']':
                        ...
                        if tokens[8].value in REGISTERS:
                            ...
                            disp = int(tokens[8].value, base=16)
                            if base == REGISTERS.index('esp'):
                                return b'\x0f\xb7\x74\x24' + pack('<B', disp)
                            else:
                                if disp <= 0x7f:
                                    modrm = 0b01000000 | dst << 3 | base
                                    return b'\x0f\xb7' + pack('<B', modrm) + pack('<B', disp)
                                else:
                                    modrm = 0b10000000 | dst << 3 | base
                                    return b'\x0f\xb7' + pack('<B', modrm) + pack('<I', disp)
                    elif tokens[7].value == '-':
                        disp = int(tokens[8].value, base=16)
                        if base == REGISTERS.index('esp'):
                            return b'\x0f\xb7\x74\x24' + pack('<b', -disp)
                ...
                if tokens[5].value == 'ds':
                    ...
                    if tokens[7].value == ']':
                        ...
                        if tokens[8].value in REGISTERS:
                            ...
                            if base == REGISTERS.index('esp'):
                                modrm = 0b01000000 | dst << 3 | base
                                return b'\x66\x0f\xb6' + pack('<B', modrm) + b'\x24' + pack('<B', disp)
                            else:
                                if disp <= 0x7f:
                                    modrm = 0b01000000 | dst << 3 | base
                                    return b'\x66\x0f\xb6' + pack('<B', modrm) + pack('<B', disp)
                                else:
                                    modrm = 0b10000000 | dst << 3 | base
                                    return b'\x66\x0f\xb6' + pack('<B', modrm) + pack('<I', disp)
                    elif tokens[7].value == '-':
                        disp = int(tokens[8].value, base=16)
                        if base == REGISTERS.index('esp'):
                            modrm = 0b01000000 | dst << 3 | base
        ...
        if tokens[1].value in REGISTERSXMM:
            ...
            if tokens[5].value == ']':
                ...
                if tokens[6].value in REGISTERS:
                    ...
                    modrm = 0b01000000 | src << 3 | base
                    if base == REGISTERS.index('esp'):
                        return b'\xf3\x0f\x11' + pack('<B', modrm) + b'\x24' + pack('<B', disp)
                    else:
                        return b'\xf3\x0f\x11' + pack('<B', modrm) + pack('<B', disp)
            ...
            if tokens[5].value == 'ds':
                ...
                if tokens[7].value == ']':
                    ...
                    if tokens[8].value in REGISTERS:
                        ...
                        if base == REGISTERS.index('esp'):
                            modrm = 0b01000000 | dst << 3 | base
                            return b'\xf3\x0f\x10' + pack('<B', modrm) + b'\x24' + pack('<B', disp)
                        else:
                            modrm = 0b01000000 | dst << 3 | base
                            return b'\xf3\x0f\x10' + pack('<B', modrm) + pack('<B', disp)
        else:
            assert False
    elif opcode == 'MOVSX':
        dst = REGISTERS.index(tokens[1].value)
                    ...
                    if tokens[8].value in REGISTERS:
                        ...
                        if tokens[11].value == ']':
                            ...
                            if disp <= 0x7f:
                                modrm = 0b01000100 | dst << 3
                                sib = 0b00000000 | scale << 6 | idx << 3 | base
                                return b'\x0f\xbe' + pack('<B', modrm) + pack('<B', sib) + pack('<B', disp)
                            else:
                                modrm = 0b10000100 | dst << 3
                                sib = 0b00000000 | scale << 6 | idx << 3 | base
                                return b'\x0f\xbe' + pack('<B', modrm) + pack('<B', sib) + pack('<I', disp)
                        elif tokens[11].value == '-':
                            disp = int(tokens[12].value, base=16)
                            assert tokens[13].value == ']'
                            if disp <= 0x7f:
                        ...
                        if base == REGISTERS.index('esp'):
                            if disp <= 0x7f:
                                modrm = 0b01000100 | dst << 3
                                return b'\x0f\xbe' + pack('<B', modrm) + b'\x24' + pack('<B', disp)
                            else:
                                modrm = 0b10000100 | dst << 3
                                return b'\x0f\xbe' + pack('<B', modrm) + b'\x24' + pack('<I', disp)
                        else:
                            if disp <= 0x7f:
                                modrm = 0b01000000 | dst << 3 | base
                                ...
                                modrm = 0b10000000 | dst << 3 | base
                                return b'\x0f\xbe' + pack('<B', modrm) + pack('<I', disp)
                elif tokens[7].value == '-':
                    disp = int(tokens[8].value, base=16)
                    assert tokens[9].value == ']'
                    modrm = 0b01000000 | dst << 3 | base
                ...
                if tokens[8].value in REGISTERS:
                    ...
                    if tokens[11].value == ']':
                        ...
                        if disp <= 0x7f:
                            modrm = 0b01000100 | dst << 3
                            sib = 0b00000000 | scale << 6 | idx << 3 | base
                            return b'\x0f\xbf' + pack('<B', modrm) + pack('<B', sib) + pack('<B', disp)
                        else:
                            modrm = 0b10000100 | dst << 3
                            sib = 0b00000000 | scale << 6 | idx << 3 | base
                            return b'\x0f\xbf' + pack('<B', modrm) + pack('<B', sib) + pack('<I', disp)
                    ...
                    if base == REGISTERS.index('esp'):
                        if disp <= 0x7f:
                            modrm = 0b01000100 | dst << 3
                            return b'\x0f\xbf' + pack('<B', modrm) + b'\x24' + pack('<B', disp)
                        else:
                            modrm = 0b10000100 | dst << 3
                            return b'\x0f\xbf' + pack('<B', modrm) + b'\x24' + pack('<I', disp)
                    else:
                        if disp <= 0x7f:
                            modrm = 0b01000000 | dst << 3 | base
                            ...
                            modrm = 0b10000000 | dst << 3 | base
                            return b'\x0f\xbf' + pack('<B', modrm) + pack('<I', disp)
            elif tokens[7].value == '-':
                disp = int(tokens[8].value, base=16)
                assert tokens[9].value == ']'
                modrm = 0b01000000 | dst << 3 | base
        ...
        if tokens[3].value in REGISTERSXMM:
            ...
            if tokens[5].value == 'ds':
                ...
                if tokens[7].value == ']':
                    modrm = 0b00000100 | dst << 3
                    return b'\x0f\x59' + pack('<B', modrm) + b'\x24'
                elif tokens[7].value == '+':
                    disp = int(tokens[8].value, base=16)
                    assert tokens[9].value == ']'
                    if base == REGISTERS.index('esp'):
                        if disp <= 0x7f:
                            modrm = 0b01000100 | dst << 3
                            return b'\x0f\x59' + pack('<B', modrm) + b'\x24' + pack('<B', disp)
                        else:
                            modrm = 0b10000100 | dst << 3
                            return b'\x0f\x59' + pack('<B', modrm) + b'\x24' + pack('<I', disp)
                    else:
                        assert False
    elif opcode == 'MULSS':
        dst = REGISTERSXMM.index(tokens[1].value)
                ...
                if tokens[5].value == ']':
                    ...
                    if tokens[6].value == 'eiz':
                        ...
                        if tokens[9].value in REGISTERS8:
                            ...
                            if disp <= 0x7f:
                                modrm = 0b01000000 | src << 3 | base
                                return b'\x08' + pack('<B', modrm) + mod + pack('<B', disp)
                            else:
                                modrm = 0b10000000 | src << 3 | base
                                return b'\x08' + pack('<B', modrm) + mod + pack('<I', disp)
                        else:
                            im = int(tokens[9].value, base=16)
                            if disp <= 0x7f:
                                modrm = 0b01001000 | base
                                return b'\x80' + pack('<B', modrm) + mod + pack('<B', disp) + pack('<B', im)
                            else:
                                modrm = 0b10001000 | base
                                return b'\x80' + pack('<B', modrm) + mod + pack('<I', disp) + pack('<B', im)
                elif tokens[5].value == '-':
                    disp = int(tokens[6].value, base=16)
                    assert tokens[7].value == ']'
                    assert tokens[8].value == ','
                    if tokens[9].value in REGISTERS8:
                        ...
                        if disp <= 0x7f:
                            ...
                            modrm = 0b10000000 | src << 3 | base
                            return b'\x08' + pack('<B', modrm) + pack('<i', -disp)
                    else:
                        im = int(tokens[9].value, base=16)
                        if disp <= 0x7f:
                            modrm = 0b01001000 | base
                ...
                if tokens[5].value == ']':
                    ...
                    if tokens[6].value in REGISTERS:
                        ...
                        if tokens[9].value in REGISTERS:
                            ...
                            if im <= 0x7f or im >= 0xffffff00:
                                if disp <= 0x7f:
                                    return prefix + b'\x83' + pack('<B', modrm) + pack('<B', disp) + pack('<B', im & 0xff)
                                else:
                                    modrm = 0b10001000 | base
                                    return prefix + b'\x83' + pack('<B', modrm) + pack('<I', disp) + pack('<B', im & 0xff)
                            else:
                                fmt = '<I'
                                if tokens[1].value == 'WORD':
                                    fmt = '<H'
                                return prefix + b'\x81' + pack('<B', modrm) + pack('<B', disp) + pack(fmt, im)
                        ...
                        modrm = 0b01000000 | src << 3 | base
                        if disp <= 0x7f:
                            return prefix + b'\x09' + pack('<B', modrm) + mod + pack('<B', disp)
                        else:
                            modrm = 0b10000000 | src << 3 | base
                            return prefix + b'\x09' + pack('<B', modrm) + mod + pack('<I', disp)
                elif tokens[5].value == '-':
                    disp = int(tokens[6].value, base=16)
                    assert tokens[7].value == ']'
                    assert tokens[8].value == ','
                    if tokens[9].value in REGISTERS:
                        ...
                        if disp <= 0x7f:
                            modrm = 0b01001000 | base
                            if tokens[1].value == 'WORD':
                                return prefix + b'\x81' + pack('<B', modrm) + pack('<b', -disp) + pack('<H', im)
                            else:
                                return prefix + b'\x83' + pack('<B', modrm) + pack('<b', -disp) + pack('<B', im & 0xff)
                        else:
                            if tokens[1].value == 'WORD':
                                return prefix + b'\x83' + pack('<B', modrm) + pack('<i', -disp) + pack('<H', im)
                            else:
                                if disp <= 0x7f:
                                    return prefix + b'\x83' + pack('<B', modrm) + pack('<i', -disp) + pack('<B', im)
                                else:
                                    return prefix + b'\x83' + pack('<B', modrm) + pack('<i', -disp) + pack('<B', im)
        elif tokens[1].value in REGISTERS8:
            dst = REGISTERS8.index(tokens[1].value)
            ...
            if tokens[3].value in REGISTERS8:
                ...
                if tokens[7].value == ']':
                    ...
                    if tokens[8].value in REGISTERS:
                        ...
                        if disp <= 0x7f:
                            modrm = 0b01000000 | dst << 3 | base
                            return b'\x0a' + pack('<B', modrm) + mod + pack('<B', disp)
                        else:
                            modrm = 0b10000000 | dst << 3 | base
                            return b'\x0a' + pack('<B', modrm) + mod + pack('<I', disp)
                elif tokens[7].value == '-':
                    disp = int(tokens[8].value, base=16)
                    assert tokens[9].value == ']'
                    if disp <= 0x7f:
                        modrm = 0b01000000 | dst << 3 | base
                        return b'\x0a' + pack('<B', modrm) + pack('<b', -disp)
                    else:
                        modrm = 0b10000000 | dst << 3 | base
                        return b'\x0a' + pack('<B', modrm) + pack('<i', -disp)
            else:
                im = int(tokens[3].value, base=16)
                ...
                if tokens[7].value == ']':
                    ...
                    if tokens[8].value in REGISTERS:
                        ...
                        if tokens[11].value == ']':
                            ...
                            if disp <= 0x7f:
                                modrm = 0b01000100 | dst << 3
                                return b'\x0b' + pack('<B', modrm) + pack('<B', sib) + pack(fmt, sign*disp)
                            else:
                                fmt = {'+': '<I', '-': '<i'}[tokens[11].value]
                                modrm = 0b10000100 | dst << 3
                                return b'\x0b' + pack('<B', modrm) + pack('<B', sib) + pack(fmt, sign*disp)
                    else:
                        disp = int(tokens[8].value, base=16)
                        ...
                        if base == REGISTERS.index('esp'):
                            mod = b'\x24'
                        if disp <= 0x7f:
                            return b'\x0b' + pack('<B', modrm) + mod + pack('<B', disp)
                        else:
                            modrm = 0b10000000 | dst << 3 | base
                            return b'\x0b' + pack('<B', modrm) + mod + pack('<I', disp)
                elif tokens[7].value == '-':
                    disp = int(tokens[8].value, base=16)
                    assert tokens[9].value == ']'
                    if disp <= 0x7f:
                        modrm = 0b01000000 | dst << 3 | base
                        return b'\x0b' + pack('<B', modrm) + pack('<b', -disp)
                    else:
                        modrm = 0b10000000 | dst << 3 | base
                        return b'\x0b' + pack('<B', modrm) + pack('<i', -disp)
                elif tokens[7].value == '*':
                    scale = get_scale(tokens[8].value)
                    assert tokens[9].value == '+'
                    disp = int(tokens[10].value, base=16)
        ...
        if tokens[3].value in REGISTERSMM:
            ...
            if tokens[5].value == '[':
                ...
                if tokens[7].value == ']':
                    ...
                    modrm = 0b01000000 | dst << 3 | base
                    if base == REGISTERS.index('esp'):
                        return b'\x0f\x6a' + pack('<B', modrm) + b'\x24' + pack('<B', disp)
                    else:
        ...
        if tokens[1].value in REGISTERS8:
            ...
            if tokens[3].value in REGISTERS:
                ...
                if tokens[7].value == '*':
                    ...
                    if tokens[8].value in REGISTERS:
                        ...
                        if base == REGISTERS.index('esp'):
                            modrm = 0b01000000 | dst << 3 | base
                            return b'\x1b' + pack('<B', modrm) + b'\x24' + pack('<B', disp)
                        else:
                            modrm = 0b01000000 | dst << 3 | base
                            return b'\x1b' + pack('<B', modrm) + pack('<B', disp)
            else:
                im = int(tokens[3].value, base=16)
            ...
            if tokens[5].value == ']':
                ...
                src = REGISTERS8.index(tokens[9].value)
                if disp <= 0x7f:
                    return b'\x18\x57' + pack('<b', -disp)
                else:
                    return b'\x18\x8e' + pack('<i', -disp)
        elif tokens[1].value == 'DWORD':
            assert tokens[2].value == 'PTR'
            assert tokens[3].value == '['
            base = REGISTERS.index(tokens[4].value)
            if tokens[5].value == ']':
                ...
                modrm = 0b01000000 | src << 3 | base
                if base == REGISTERS.index('esp'):
                    return b'\x19' + pack('<B', modrm) + b'\x24' + pack('<B', disp)
                else:
                    return b'\x19' + pack('<B', modrm) + pack('<B', disp)
            elif tokens[5].value == '-':
                disp = int(tokens[6].value, base=16)
                assert tokens[7].value == ']'
                assert tokens[8].value == ','
        ...
        if tokens[1].value == 'BYTE':
                    ...
                    if tokens[6].value in REGISTERS:
                        ...
                        if tokens[9].value in REGISTERS:
                            ...
                            if disp <= 0x7f:
                                ...
                                modrm = 0b10000000 | src << 3 | base
                                return b'\x29' + pack('<B', modrm) + pack('<I', disp)
                        else:
                            im = int(tokens[9].value, base=16)
                            mod = b''
                            if base == REGISTERS.index('esp'):
                            ...
                            modrm = 0b01101000 | base
                            if im <= 0x7f:
                                return b'\x83' + pack('<B', modrm) + mod + pack('<B', disp) + pack('<B', im)
                            else:
                                return b'\x81' + pack('<B', modrm) + mod + pack('<B', disp) + pack('<I', im)
                elif tokens[5].value == '-':
                    disp = int(tokens[6].value, base=16)
            ...
            if tokens[3].value in REGISTERS16:
                ...
                if tokens[7].value == ']':
                    ...
                    if disp <= 0x7f:
                        modrm = 0b01000000 | dst << 3 | base
                        return b'\x66\x2b' + pack('<B', modrm) + pack('<B', disp)
                    else:
                        modrm = 0b10000000 | dst << 3 | base
                        return b'\x66\x2b' + pack('<B', modrm) + pack('<I', disp)
            else:
                im = int(tokens[3].value, base=16)
                if dst == REGISTERS16.index('ax'):
                ...
                if tokens[5].value == 'ds':
                    ...
                    if tokens[7].value == ']':
                        ...
                        if tokens[8].value in REGISTERS:
                            ...
                            if disp <= 0x7f:
                                modrm = 0b01000000 | dst << 3 | base
                                return b'\x2b' + pack('<B', modrm) + mod + pack('<B', disp)
                            else:
                                modrm = 0b10000000 | dst << 3 | base
                                return b'\x2b' + pack('<B', modrm) + mod + pack('<I', disp)
                    elif tokens[7].value == '-':
                        disp = int(tokens[8].value, base=16)
                        assert tokens[9].value == ']'
                        if disp <= 0x80:
            ...
            if tokens[3].value == 'ds':
                ...
                if tokens[4].value == 'esp':
                    ...
                    if tokens[9].value in REGISTERS8:
                        ...
                        if disp <= 0x7f:
                            modrm = 0b01000100 | src << 3
                            return b'\x84' + pack('<B', modrm) + b'\x24' + pack('<B', disp)
                        else:
                            modrm = 0b10000100 | src << 3
                            return b'\x84' + pack('<B', modrm) + b'\x24' + pack('<I', disp)
                    else:
                        ib = int(tokens[9].value, base=16)
                        sib = 0b00100100
                        if disp <= 0x7f:
                        ...
                        if tokens[6].value in REGISTERS:
                            ...
                            if tokens[9].value == ']':
                                ...
                                if tokens[13].value in REGISTERS8:
                                    ...
                                    modrm = 0b00000000 | scale << 6 | idx << 3 | reg
                                    ib = int(tokens[13].value, base=16)
                                    if disp <= 0x7f:
                                        return b'\xf6\x44' + pack('<B', modrm) + pack('<B', disp) + pack('<B', ib)
                                    else:
                                        return b'\xf6\x84' + pack('<B', modrm) + pack('<I', disp) + pack('<B', ib)
                        else:
                            disp = int(tokens[6].value, base=16)
                            assert tokens[7].value == ']'
                            assert tokens[8].value == ','
                            if tokens[9].value in REGISTERS8:
                                ...
                                if disp <= 0x7f:
                                    modrm = 0b01000000 | src << 3 | reg
                                    return b'\x84' + pack('<B', modrm) + pack('<B', disp)
                                else:
                                    modrm = 0b10000000 | src << 3 | reg
                                    return b'\x84' + pack('<B', modrm) + pack('<I', disp)
                            else:
                                ib = int(tokens[9].value, base=16)
                ...
                if tokens[5].value == ']':
                    ...
                    if tokens[6].value in REGISTERS:
                        ...
                        if tokens[9].value in REGISTERS:
                            ...
                            if disp <= 0x7f:
                                ...
                                modrm = 0b10000000 | src << 3 | reg
                                return prefix + b'\x85' + pack('<B', modrm) + pack('<I', disp)
                        else:
                            im = int(tokens[9].value, base=16)
                            if disp <= 0x7f:
                                ...
                                if tokens[1].value == 'WORD':
                                    fmt = '<H'
                                if reg == REGISTERS.index('esp'):
                                    return prefix + b'\xf7' + pack('<B', modrm) + b'\x24' + pack('<B', disp) + pack(fmt, im)
                                else:
                                    return prefix + b'\xf7' + pack('<B', modrm) + pack('<B', disp) + pack(fmt, im)
                            else:
                                if tokens[4].value in ['ecx']:
                    ...
                    if tokens[9].value in REGISTERS:
                        ...
                        if tokens[1].value == 'WORD':
                            fmt = '<H'
                        if disp <= 0x7f:
                            return prefix + b'\xf7\x45' + pack('<b', -disp) + pack(fmt, im)
                        else:
                            return prefix + b'\xf7\x83' + pack('<i', -disp) + pack(fmt, im)
                else:
                    assert False, 'Not implemented'
            else:
                assert False, 'Not implemented'
            ...
            if tokens[3].value in REGISTERS:
                ...
                if tokens[7].value == ']':
                    ...
                    if tokens[8].value in REGISTERS:
                        ...
                        if disp <= 0x7f:
                            modrm = 0b01000100 | dst << 3
                            return b'\x33' + pack('<B', modrm) + pack('<B', sib) + pack('<B', disp)
                        else:
                            modrm = 0b10000100 | dst << 3
