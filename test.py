...
from asm import ident, literal, symbol, tokenize, Token
...
def test_assemble():
    cases = [
        ...
        ['AND BYTE PTR [eax+ebp*2], ch',    b'\x20\x2c\x68'],
        ['AND BYTE PTR [edx+0x40], al',     b'\x20\x42\x40'],
        ['AND BYTE PTR [ebp-0x1], al',      b'\x20\x45\xff'],
        ...
        ['AND DWORD PTR [ebp+edx*1-0x40], eax',b'\x21\x44\x15\xc0'],
        ['AND DWORD PTR [ebp+0x8], eax',    b'\x21\x45\x08'],
        ['AND DWORD PTR [eax+edi*4+0x44], ebx',b'\x21\x5c\xb8\x44'],
        ['AND DWORD PTR [ebp-0x18], ebx',   b'\x21\x5d\xe8'],
        ['AND DWORD PTR [esp+0xc], esi',    b'\x21\x74\x24\x0c'],
        ['AND DWORD PTR [eax+edi*4+0xc4], ebx',b'\x21\x9c\xb8\xc4\x00\x00\x00'],
        ...
        ['AND al, ch',                      b'\x22\xc5'],
        ['AND dl, dl',                      b'\x22\xd2'],
        ['AND eax, DWORD PTR [esi*8+0x88dca4]',b'\x23\x04\xf5\xa4\xdc\x88\x00'],
        ...
        ['AND eax, DWORD PTR ds:0x8eb1c0',  b'\x23\x05\xc0\xb1\x8e\x00'],
        ['AND eax, DWORD PTR [esp+0xc]',    b'\x23\x44\x24\x0c'],
        ['AND eax, DWORD PTR [ebp-0x4]',    b'\x23\x45\xfc'],
        ['AND ebx, DWORD PTR [ebp+esi*1+0x24]',b'\x23\x5c\x35\x24'],
        ['AND esp, DWORD PTR [esi+eiz*2+0x0]',b'\x23\x64\x66\x00'],
        ['AND al, 0x1',                     b'\x24\x01'],
        ['AND eax, 0x2000',                 b'\x25\x00\x20\x00\x00'],
        #['AND eax, 0xffffff10',             b'\x25\x10\xff\xff\xff'],
        ['AND BYTE PTR [eax], 0x1',         b'\x80\x20\x01'],
        ['AND BYTE PTR [esi+eax*1], 0x0',   b'\x80\x24\x06\x00'],
        ['AND BYTE PTR [edi], 0x0',         b'\x80\x27\x00'],
        ['AND BYTE PTR [esp+eax*1+0x50], 0x0',b'\x80\x64\x04\x50\x00'],
        ['AND BYTE PTR [ebp+ebx*1-0x2c], 0x0',b'\x80\x64\x1d\xd4\x00'],
        ['AND BYTE PTR [ebp+0x16], 0xcf',   b'\x80\x65\x16\xcf'],
        ['AND BYTE PTR [ebp-0x1], 0x0',     b'\x80\x65\xff\x00'],
        ['AND BYTE PTR [esi-0x1], 0x0',     b'\x80\x66\xff\x00'],
        ['AND BYTE PTR [eax+0xba7020], 0x0',b'\x80\xa0\x20\x70\xba\x00\x00'],
        ['AND BYTE PTR [ebp+eax*1-0x425], 0x0',b'\x80\xa4\x05\xdb\xfb\xff\xff\x00'],
        ['AND BYTE PTR [ebp-0xf01], 0x0',   b'\x80\xa5\xff\xf0\xff\xff\x00'],
        ['AND dl, 0x1c',                    b'\x80\xe2\x1c'],
        ['AND DWORD PTR [eax], 0x2000',     b'\x81\x20\x00\x20\x00\x00'],
        ['AND DWORD PTR [esp+0x4], 0xbcff', b'\x81\x64\x24\x04\xff\xbc\x00\x00'],
        ['AND DWORD PTR [ebp-0x4], 0x1fff', b'\x81\x65\xfc\xff\x1f\x00\x00'],
        ['AND ecx, 0xff',                   b'\x81\xe1\xff\x00\x00\x00'],
        ['AND edi, 0x80000003',             b'\x81\xe7\x03\x00\x00\x80'],
        ['AND DWORD PTR [eax], 0x1',        b'\x83\x20\x01'],
        ['AND DWORD PTR [edx], 0xfffffffc', b'\x83\x22\xfc'],
        ['AND DWORD PTR [ecx+eax*4], 0x0',  b'\x83\x24\x81\x00'],
        ...
        ['AND DWORD PTR [esp+0x10], 0x0',   b'\x83\x64\x24\x10\x00'],
        ['AND DWORD PTR [eax+edi*1+0x4], 0x0',b'\x83\x64\x38\x04\x00'],
        ['AND DWORD PTR [ebp+edi*4-0x38], 0x0',b'\x83\x64\xbd\xc8\x00'],
        ['AND DWORD PTR [ebp+0x18], 0x0',   b'\x83\x65\x18\x00'],
        ['AND DWORD PTR [ebp-0x14], 0x0',   b'\x83\x65\xec\x00'],
        ['AND DWORD PTR [ebp-0x4], 0xfffffff7',b'\x83\x65\xfc\xf7'],
        ['AND DWORD PTR [eax+0x1094], 0x0', b'\x83\xa0\x94\x10\x00\x00\x00'],
        ['AND DWORD PTR [eax+ecx*4+0xc4], 0x0',b'\x83\xa4\x88\xc4\x00\x00\x00\x00'],
        ['AND DWORD PTR [ebp-0xec], 0x0',   b'\x83\xa5\x14\xff\xff\xff\x00'],
        ['AND eax, 0x4',                    b'\x83\xe0\x04'],
        ['AND esi, 0xfffffff8',             b'\x83\xe6\xf8'],
        ['AND bx, dx',                      b'\x66\x23\xda'],
        ['AND ax, 0x7ff0',                  b'\x66\x25\xf0\x7f'],
        ['AND WORD PTR [esi+0xc], 0xfbf7',  b'\x66\x81\x66\x0c\xf7\xfb'],
        ['AND dx, 0x80',                    b'\x66\x81\xe2\x80\x00'],
        ['AND WORD PTR [eax], 0x0',         b'\x66\x83\x20\x00'],
        ['AND WORD PTR [edi-0x2], 0x0',     b'\x66\x83\x67\xfe\x00'],
        ['AND ax, 0x20',                    b'\x66\x83\xe0\x20'],
